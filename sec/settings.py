...
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', default='hppkramhnyqlxhxq') #app password
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': datetime.timedelta(days=int(env('JWT_TOKEN_LIFETIME'))),
